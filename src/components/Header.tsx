    ...
    return (
        <div className="flex flex-row items-center
            ...
            <div className="relative flex items-center ml-4">
                ...
                <input type="search" className="rounded-lg text-md text-gray-900 dark:text-gray-100 dark:bg-gray-800 w-40 h-9 pl-10 focus:outline-none drop-shadow-xl z-10" placeholder="Search..."></input>
            </div>
