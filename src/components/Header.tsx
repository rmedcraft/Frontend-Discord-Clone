...
export default function Header(props: any) {
    return (
        <div className="flex flex-row items-center
                        ...
                        bg-gray-300 dark:bg-gray-700 shadow-lg
                        -z-10
                        transition-all">
            ...
            <div className="relative flex items-center ml-4">
                ...
                <input type="search" className="rounded-lg text-md text-gray-900 focus:border-2 focus:border-green-500 w-40 h-9 pl-10 focus:outline-none transition-all drop-shadow-xl z-10" placeholder="Search..."></input>
            </div>
